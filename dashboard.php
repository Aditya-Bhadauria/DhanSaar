...
body {
	...
	background-image: url('assets/images/Khata.jpg'); /* Add your image here */
...
.easypiechart-panel {
	...
	/* Lighter purple background for chart panels */
}
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="background-color:#ede7f6">Dashboard</h1>
			</div>
		</div><!--/.row-->
...
$sum_yearly_expense=$result4['yearlyexpense'];
 ?>
						...
						<div class="easypiechart" id="easypiechart-purple" data-percent="<?php echo $sum_yearly_expense;?>" ><span class="percent"><?php if($sum_yearly_expense==""){
echo "0";
} else {
